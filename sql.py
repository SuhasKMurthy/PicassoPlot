...
tpch_7_query = 'SELECT supp_nation, cust_nation, l_year, sum(volume) as revenue ' \
               ...
               'FROM supplier, lineitem, orders, customer, nation n1, nation n2 ' \
                    'WHERE s_suppkey = l_suppkey and o_orderkey < :foo and c_custkey < :bar ' \
                            'and s_nationkey = n1.n_nationkey and c_nationkey = n2.n_nationkey and ( ' \
                            '(n1.n_name = \'CHINA\' and n2.n_name = \'UNITED STATES\') or (n1.n_name = \'UNITED STATES\' and n2.n_name = \'CHINA\')) ' \
